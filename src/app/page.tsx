    ...
    <main style={{ background: '#fff', minHeight: '100vh' }}>
      ...
      <nav className="nav-container">
        <a href="https://fetchpet.com.au" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
          <img src="/fetch-pet-insurance_1.png" alt="Fetch" style={{ height: '50px' }} />
        </a>
      ...
      <section className="hero-section">
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 36px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px, 7vw, 72px)', fontWeight: 700, lineHeight: 1.05, color: '#111', margin: '0 0 20px', letterSpacing: '-2px' }}>
      ...
      <section className="how-it-works-section">
        <h2 style={{ fontSize: 'clamp(28px, 5vw, 52px)', fontWeight: 700, textAlign: 'center', color: '#111', marginBottom: '40px', letterSpacing: '-1px' }}>
          How it works?
        </h2>
